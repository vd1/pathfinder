...
initially $Q3P3$ and $Q4P6$. Compare the current protocol with alternatives
...
possible labels: the conditional judge-free ranking construction for $Q4P6$,
or the identification and design of a missing matched-budget control for
$Q3P3$. The latter is an experimental-design contribution, not evidence that
...
assumptions of the $Q4P6$ ranking construction, establish its finite-sample
