...
Isolation: work only in this copied thread. Do not change inputs, the ledger, research notes or files outside it. Preserve the supported scope.
Before finishing, run /Users/v/.local/bin/style-ban-artifacts on paper/paper.tex and paper/search.md, and /Users/v/.codex/skills/style-gates/scripts/style_gate.py on those files and paper/paper.pdf. Correct artifact errors.
