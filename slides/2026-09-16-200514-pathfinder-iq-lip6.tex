...
\newcommand{\dline}[3]{\par\noindent\makebox[17mm][l]{\color{#1}\fontsize{13}{17}\selectfont\bfseries #2}%
  \parbox[t]{\dimexpr\linewidth-17mm\relax}{\fontsize{13}{17}\selectfont\raggedright #3}\par\vspace{4mm}}
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \draw[Teal,line width=.9pt,fill=Paper] (.75,2.05) rectangle (4.55,3.95);
  \node[font=\small,align=center] at (2.65,3.0) {An outside judge\\ranks the agents};
  \fill[Rust] (1.3,1.55) circle (.2);
  \fill[Rust,rounded corners=2.5pt] (1.05,.68) rectangle (1.55,1.27);
  \draw[Rust,line width=1pt,line cap=round] (1.55,1.15) -- (2.05,1.95);
  \node[font=\scriptsize,text=Rust] at (1.3,.38) {Alice, author of P6};
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{.315\textwidth}
    {\Large\color{Teal}\textbf{Recover}}\par\vspace{2mm}
  ...
  \end{column}
  \begin{column}{.315\textwidth}
    {\Large\color{Teal}\textbf{Account}}\par\vspace{2mm}
  ...
  \end{column}
  \begin{column}{.315\textwidth}
    {\Large\color{Teal}\textbf{Reuse}}\par\vspace{2mm}
...
\vspace{1mm}
\begin{tikzpicture}[x=1.22cm,y=1cm]
  \path[use as bounding box] (0,-.1) rectangle (14.5,3.5);
  ...
  \node[agent] (a) at (9.95,1.55) {};
  \node[agent] (b) at (11.05,2.35) {};
  \node[agent] (c) at (11.05,.75) {};
  \node[agent] (d) at (12.4,2.35) {};
  \node[agent] (e) at (13.1,.75) {};
  \draw[Teal,line width=1pt] (a)--(b)--(c)--(a) (b)--(d)--(e)--(c);
  \node[font=\scriptsize,align=left,anchor=west,text=Muted] at (13.35,1.6) {overlap\\calibrates\\observers};
...
\begin{column}{.52\textwidth}
  ...
  \includegraphics[width=\dimexpr\linewidth-7pt\relax,height=6.3cm,keepaspectratio]{\assetdir/julien-dashboard.png}}}
\end{column}
...
\begin{frame}[plain]
\vspace{12mm}
{\rmfamily\fontsize{36}{42}\selectfont How much of creativity\\is connexion?}\par
